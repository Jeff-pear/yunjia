...
*/
(function($ , undefined) {
	var jeff_colorpicker = function(element, _options) {

		var attrib_values = jeff.helper.getAttrSettings(element, $.fn.jeff_colorpicker.defaults);
		var options = $.extend({}, $.fn.jeff_colorpicker.defaults, _options, attrib_values);
		...
		dropdown.on(jeff.click_event, function(e) {
			var a = $(e.target);
		...
		this.pick = function(index, insert) {
			if(typeof index === 'number') {
				...
				dropdown.find('a:eq('+index+')').trigger(jeff.click_event);
			}
	...
	$.fn.jeff_colorpicker = function(option, value) {
		var retval;

		var $set = this.each(function () {
			var $this = $(this);
			var data = $this.data('jeff_colorpicker');
			var options = typeof option === 'object' && option;

			if (!data) $this.data('jeff_colorpicker', (data = new jeff_colorpicker(this, options)));
