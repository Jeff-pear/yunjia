...
(function($ , undefined) {
	...
	$.fn.aceTree = $.fn.ace_tree = function(options) {
		var $defaults = {
			'open-icon' : jeff.vars['icon'] + 'fa fa-folder-open',
			'close-icon' : jeff.vars['icon'] + 'fa fa-folder',
			'toggle-icon': jeff.vars['icon'] + 'fa fa-play',
			'selected-icon' : jeff.vars['icon'] + 'fa fa-check',
			'unselected-icon' : jeff.vars['icon'] + 'fa fa-times',
			'base-icon' : jeff.vars['icon'] + 'fa',
		...
		this.each(function() {
			...
			var attrib_values = jeff.helper.getAttrSettings(this, $defaults);
